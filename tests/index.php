<?php include("../non-pages/php-include/top.php"); ?><!-- MUST MANUALLY LINK TO top.php & USING ../ but use $upFolderPlaceHolder from now on -->
    <h1 class="cent"><?php echo $pageTitle ?></h1><!-- display page title -->
    
	<h4>Kind of hidden page. You don't really need a page for the dropdowns, the menu takes care of that, but just in case</h4>
